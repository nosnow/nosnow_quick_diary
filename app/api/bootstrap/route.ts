import { getDescription, getFieldDefinitions, getFieldLabels, getRecord, getTemplate, listRecordDates } from "@/lib/journal";
...
export async function GET(req: Request) {
  ...
  const [template, fieldLabels, fieldDefinitions, dates, description] = await Promise.all([
    getTemplate(),
    getFieldLabels(),
    getFieldDefinitions(),
    listRecordDates(),
